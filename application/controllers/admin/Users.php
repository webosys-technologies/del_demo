...
class Users extends CI_Controller
{
	...
	public function user_add()
	{
                ...
                $data['user_id'] = $this->User_model->user_add($data);
	...
	public function user_update()
	{
                ...
                'user_status'  => $this->input->post('status'),
                  ...
                  $this->User_model->user_update(array('user_id' => $this->input->post('id')), $data);
    ...
    {   
      $id=$data['user_id'];
         ...
         $config = array(
                   ...
                   $insert =  $this->User_model->user_update(array('student_id' =>$id), $pic);
