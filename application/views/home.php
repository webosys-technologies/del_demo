  ...
  <div class="container">
    <nav class="navbar navbar-inverse" role="navigation">
      <div class="navbar-header">
        ...
        <a href="#" class="navbar-brand scroll-top logo  animated bounceInLeft"><b><i><img src="<?php echo base_url(); ?>assets/images/logo.png" /></i></b></a> </div>
      <!--/.navbar-header-->
      <div id="main-nav" class="collapse navbar-collapse">
        <ul class="nav navbar-nav" id="mainNav">
          <li class="active" id="firstLink"><a href="#home" class="scroll-link">Home</a></li>
          <li><a href="#Features" class="scroll-link">About Us </a></li>
...
<section id="home">
  ...
  <div class="carousel-inner">
    <div class="active item"><img src="<?php echo base_url(); ?>assets/images/banner-bg.jpg" alt="banner" /></div>
    <div class="item"><img src="<?php echo base_url(); ?>assets/images/banner-bg2.jpg" alt="banner" /></div>
    <div class="item"><img src="<?php echo base_url(); ?>assets/images/banner-bg3.jpg" alt="banner" /></div>
  </div>
  <!-- Carousel nav -->
