  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
      ...
      if(isset($user_info))
      {
         ...
         $user_profile_pic=$user_info->user_profile_pic;         
      }
      ?>
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <!--<img src="<?php echo base_url(); ?>assets/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">-->
               <img src='<?php if($user_profile_pic){echo base_url(); echo $user_profile_pic;}else{ echo base_url()."profile_pic/boss.png"; }?>' class="user-image" alt="User Image"/>
                <span class="hidden-xs"><?php echo $user_fname." ".$user_lname;?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree" id="search_area">
        ...
        <li>
          <a href="<?php echo base_url(); ?>admin/Centers">
            <i class="fa fa-institution"></i> <span>Centers</span>
       ...
       <li>
        ...
        <li><a href="<?php echo base_url(); ?>admin/Orders"><i class="fa fa-book"></i>
...
<!--        <li><a href="#"><i class="fa fa-book"></i> 
        <span>Exams</span></a></li>-->
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url(); ?>admin/Reports/center_report"><i class="fa fa-circle-o"></i>Center Report</a></li>
            <li><a href="<?php echo base_url(); ?>admin/Reports/student_report"><i class="fa fa-circle-o"></i>Student Report</a></li>
