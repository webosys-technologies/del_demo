...
$("#myName").on("keyup", function() {
    ...
    function edit_sub_center(id)
    {
     ...
     $('#form')[0].reset(); // reset form on modals
      ...
      $.ajax({
        url : "<?php echo site_url('index.php/admin/Sub_center/ajax_edit/')?>/" + id,        
        type: "GET",
...
//                     $("#append_city").remove();
    ...
    function save()
    {
      ...
      if(save_method == 'add')
      {
        url = "<?php echo site_url('index.php/admin/Sub_center/sub_center_add')?>";
      }
      else
      {
        url = "<?php echo site_url('index.php/admin/Sub_center/sub_center_update')?>";
      }
    ...
    function delete_sub_center(id)
    {
      if(confirm('Are you sure delete this data?'))
      {
        // ajax delete data from database
          $.ajax({
            url : "<?php echo site_url('index.php/admin/Sub_center/sub_center_delete')?>/"+id,
            type: "POST",
            //dataType: "JSON",
            success: function(data)
            {
