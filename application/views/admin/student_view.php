...
<!--                            <div class="row">
                                <div class="col-md-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="city"  name="student_city" maxlength="128" required>
                                    </div>
                                </div>
                                <div class="col-md-5 col-md-offset-1">
                                    <div class="form-group">
                                        <label for="state">State</label>
                                        <input type="text" class="form-control required " id="state" name="student_state" maxlength="128" required>
                                    </div>
                                </div>
                            </div>-->
