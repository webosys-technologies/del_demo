...
<div class="content-wrapper">
    ...
    <form id="table" name="table" action="<?php echo base_url(); ?>admin/Orders/payment" method="post">
    <section class="content-header">
    <div class="row">
   ...
   <div id="print">
    ...
    ?>
    <input type="hidden" name="center" value="<?php echo $res->center_id; ?> ">    
    ...
    <row>
        <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <a href="<?php echo base_url(); ?>admin/Students" class="btn btn-primary" >Previous</a>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="row">
                <div class="col-md-3 col-sm-3 col-xs-12"></div>  
                <div class="col-md-3 col-sm-3 col-xs-12"> <button type="submit" class="btn btn-warning" id="payment"  ><i class="glyphicon glyphicon-plus"></i> Complete Order</button></div>  
                 <div class="col-md-3 col-sm-3 col-xs-12"></div>
            </div>
  ...
  $('#apply').click(function(){
     ...
     var total_amount = $('input[name=amount]').val();
        ...
        {
            type: "POST",
            url: '<?php echo site_url('index.php/admin/Orders/get_coupon')?>',
            data: {txt1: textboxvalue,amt: amount,std: student,cen: center},
            dataType : "JSON",
