...
<div class="content-wrapper">
    ...
    <div class="row">
    <div class="col-md-4">
    <button type="button" class="btn btn-primary" onclick="demo_view()"><i class="glyphicon glyphicon-plus"></i> Add Batch</button>
      </div>
       <div class="col-md-6">
         <?php
        ...
        <?php
         ...
         foreach($batch_data as $res){
          ...
          <tr>
                  ...
                  <button type="button" class="btn btn-success" onclick="demo_view()" data-toggle="tooltip" data-placement="bottom" title="Edit Batch" ><i class="glyphicon glyphicon-pencil"></i></button>
                  ...
                  <button type="button" class="btn btn-danger" onclick="demo_view()" data-toggle="tooltip" data-placement="bottom" title="Delete Batch" ><i class="glyphicon glyphicon-trash"></i></button>
...
$("#myName").on("keyup", function() {
    ...
    function edit_batch(id)
    {
     ...
     $('#form')[0].reset(); // reset form on modals
      ...
      $.ajax({
        url : "<?php echo site_url('index.php/center/Batches/ajax_edit/')?>/" + id,        
        type: "GET",
...
//                     $("#append_city").remove();
    ...
    function save()
    {
      ...
      if(save_method == 'add')
      {
        url = "<?php echo site_url('index.php/center/Batches/batch_add')?>";
      }
      else
      {
        url = "<?php echo site_url('index.php/center/Batches/batch_update')?>";
      }
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5 col-md-offset-1 ">
                                    <div class="form-group">
                                        ...
                                        <input type="time" placeholder="00:00:AM/PM" class="form-control required email" id="batch_time"  name="batch_time" maxlength="128"  style="text-transform:uppercase" required>
                                    </div>
                                </div>
                            </div>   
