      ...
      <ul class="nav nav-pills nav-stacked" >
         ...
         <li id="topic_font"> <?php 
                  ...
                  $i=0;
          {
             ...
             <a href="<?php echo base_url();?>student/Topics/topic_encrypt/<?php echo custom_encode($topic->topic_id);?>" id="topic<?php echo $topic->topic_id; ?>"><?php echo $i.'. '.$topic->topic_name;?></a>
